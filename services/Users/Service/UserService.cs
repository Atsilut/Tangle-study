...
namespace Users.Service
{
...

    {
        ...
        public async Task DeleteUserAsync(long id)
        {
            ...
            // Detach runs outside the DB transaction: HTTP side effects cannot roll back with Postgres.
            // Downstream detach endpoints must be idempotent so a retry after partial failure is safe.
