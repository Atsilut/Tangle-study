...
namespace Tangle.AspNetCore.Db;

/// <summary>
/// Applies EF Core migrations and exits. Invoked via <c>dotnet Service.dll --migrate</c>.
/// </summary>
public static class DatabaseMigrationRunner
{
    public static async Task<int> RunAsync<TDbContext>(string[] args, CancellationToken cancellationToken = default)
