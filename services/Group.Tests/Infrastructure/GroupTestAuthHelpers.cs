...
internal static class GroupTestAuthHelpers
{
    public static void LoginAs(HttpClient client, long userId, string? secret = null)
    {
        secret ??= GroupWebApplicationFactory.TestJwtSecret;
    ...
    public static void LoginAsInternal(HttpClient client, long? userId = null)
    {
        ...
        client.DefaultRequestHeaders.Add(
            "X-Internal-Secret",
            GroupWebApplicationFactory.TestInternalServiceSecret);
    ...
    public static string CreateToken(long userId, string? secret = null)
    {
        ...
        var token = new JwtSecurityToken(
            issuer: GroupWebApplicationFactory.TestJwtIssuer,
            audience: GroupWebApplicationFactory.TestJwtAudience,
