...
public sealed class ChatRoomAccessIntegrationMatrixTests(PostgresTestcontainerFixture postgres, RedisTestcontainerFixture redis)
    : ChatIntegrationMatrixTestBase(postgres, redis)
{
