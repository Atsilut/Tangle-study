    ...
    ILogger<FriendRequestService> logger)
{
    ...
    private static FriendRequestGetResponseDto MapRequestToDto(FriendRequest request, long viewerId, string otherUserNickname) =>
        new(
            Id: request.Id,
    ...
    public Task DeleteAllFriendRequestsForUserAsync(long userId) => _repo.DeleteAllForUserAsync(userId);
