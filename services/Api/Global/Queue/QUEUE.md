...
Start: `docker compose --profile workers up -d rust-worker-location`. Details: [LOCATION.md](../../../Location/LOCATION.md). Chat worker: [workers/README.md](../../../../workers/README.md).
