...
Direct-to-storage uploads (Azure Blob / Azurite locally), async processing via Redis Streams + [rust-worker-media](../../../../workers/rust-worker/README.md), and attachment by ID on posts, comments, and chat messages.

Stream contract: [Global/Queue/QUEUE.md](../../Global/Queue/QUEUE.md). Size limits: [`media-limits.yml`](../../media-limits.yml).
