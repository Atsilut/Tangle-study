...
internal sealed record InternalAccessIsBlockedRequestDto(long BlockerUserId, long BlockedUserId);

internal sealed record InternalAccessIsBlockedResponseDto(bool IsBlocked);
