...
/// <c>X-Metrics-Secret</c>. Not JWT user login — see <see cref="AuthorizedEndpointsIntegrationTests"/>.
/// </summary>
[Collection(IntegrationTestCollection.Name)]
public sealed class MetricsScrapeAuthIntegrationTests(PostgresTestcontainerFixture postgres) : IAsyncLifetime
{
