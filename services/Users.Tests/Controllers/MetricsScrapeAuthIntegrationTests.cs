...
/// <c>X-Metrics-Secret</c>. Not gateway user login — see <see cref="AuthorizedEndpointsIntegrationTests"/>.
/// </summary>
[Collection(UsersIntegrationTestCollection.Name)]
public sealed class MetricsScrapeAuthIntegrationTests(
    PostgresTestcontainerFixture postgres,
    RedisTestcontainerFixture redis) : IAsyncLifetime
{
    private const string TestMetricsSecret = "test-metrics-secret";

    private UsersWebApplicationFactory _factory = null!;
